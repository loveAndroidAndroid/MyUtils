package com.rmyh.myutils.utils.FileUtils;
...
public class FileUtil {
	...
	public static String createFile(String dir_name, String file_name) {
		...
		String dir_path = String.format("%s/download/", sdcard_path);
		String file_path = String.format("%s/download/%s", sdcard_path, file_name);
		try {
